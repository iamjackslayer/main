...
If you are new to contributing to ClinicIO, head over to <<#Setting Up, Setting Up>> to start
set up ClinicIO project.

== Setting up

=== Prerequisites

Before you start setting up the project, these are the list of prerequisites that you need to install: +
...
The following sequence diagram shows how the login works:
